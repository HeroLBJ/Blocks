...
//        }.start();
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            LogUtils.e("an error occured when collect package info"+e.getMessage());
        }
        ...
        for (Field field : fields) {
            try {
                ...
                LogUtils.e("an error occured when collect crash info"+e.getMessage());
            }
        }
    }
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        String fileName=formatter.toString()+".txt";
        File logPath = FilePath.getLogPath();
        KLog.file(TAG,logPath ,fileName , crashInfo);
        return logPath.getPath()+"/"+fileName;
    }
}
